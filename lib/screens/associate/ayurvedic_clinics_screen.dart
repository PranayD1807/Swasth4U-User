import 'package:demo/screens/associate/ayurvedic_clinic_list_screen.dart';
import 'package:demo/widgets/home_options.dart';
import 'package:demo/widgets/page_heading.dart';
import 'package:flutter/material.dart';

class AyurvedicClinicsScreen extends StatefulWidget {
  const AyurvedicClinicsScreen({Key? key}) : super(key: key);

  @override
  State<AyurvedicClinicsScreen> createState() => _AyurvedicClinicsScreenState();
}

class _AyurvedicClinicsScreenState extends State<AyurvedicClinicsScreen> {
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => AyurvedicClinicListScreen(
                            ayurvedicClinic: tools[i]["text"],
                          ),
                        ),
                      );
                    },
