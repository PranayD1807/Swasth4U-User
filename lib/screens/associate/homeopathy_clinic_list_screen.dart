...
class HomeopathyClinicListScreen extends StatefulWidget {
  const HomeopathyClinicListScreen({Key? key, required this.homeopathyClinic})
      : super(key: key);
  final String homeopathyClinic;
  @override
  State<HomeopathyClinicListScreen> createState() =>
      _HomeopathyClinicListScreenState();
}

class _HomeopathyClinicListScreenState
    extends State<HomeopathyClinicListScreen> {
