import 'package:demo/screens/associate/diagnostic_centres_list_screen.dart';
import 'package:demo/widgets/home_options.dart';
import 'package:demo/widgets/page_heading.dart';
import 'package:flutter/material.dart';

class DiagnosticCentres extends StatefulWidget {
  const DiagnosticCentres({Key? key}) : super(key: key);

  @override
  State<DiagnosticCentres> createState() => _DiagnosticCentresState();
}

class _DiagnosticCentresState extends State<DiagnosticCentres> {
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => DiagnosticCentresListScreen(
                            diagnosticCentres: tools[i]["text"],
                          ),
                        ),
                      );
                    },
