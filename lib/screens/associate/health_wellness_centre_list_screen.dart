...
class HealthWellNessCentreListScreen extends StatefulWidget {
  const HealthWellNessCentreListScreen(
      {Key? key, required this.healthWellnessCentre})
      : super(key: key);
  final String healthWellnessCentre;
  @override
  State<HealthWellNessCentreListScreen> createState() =>
      _HealthWellNessCentreListScreenState();
}

class _HealthWellNessCentreListScreenState
    extends State<HealthWellNessCentreListScreen> {
      ...
      body: Builder(builder: (context) {
        return SingleChildScrollView(
          ...
          child: Column(
            children: <Widget>[
              PageHeading(
                text: widget.healthWellnessCentre,
              ),
              Container(
                margin:
