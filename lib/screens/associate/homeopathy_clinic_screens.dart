import 'package:demo/screens/associate/homeopathy_clinic_list_screen.dart';
import 'package:demo/widgets/home_options.dart';
import 'package:demo/widgets/page_heading.dart';
import 'package:flutter/material.dart';

class HomeopathyClinicsScreen extends StatefulWidget {
  const HomeopathyClinicsScreen({Key? key}) : super(key: key);

  @override
  State<HomeopathyClinicsScreen> createState() =>
      _HomeopathyClinicsScreenState();
}

class _HomeopathyClinicsScreenState extends State<HomeopathyClinicsScreen> {
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => HomeopathyClinicListScreen(
                            homeopathyClinic: tools[i]["text"],
                          ),
                        ),
                      );
                    },
