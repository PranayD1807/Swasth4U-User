...
class AyurvedicClinicListScreen extends StatefulWidget {
  const AyurvedicClinicListScreen({Key? key, required this.ayurvedicClinic})
      : super(key: key);
  final String ayurvedicClinic;
  @override
  State<AyurvedicClinicListScreen> createState() =>
      _AyurvedicClinicListScreenState();
}

class _AyurvedicClinicListScreenState extends State<AyurvedicClinicListScreen> {
