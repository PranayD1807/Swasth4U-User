...
class DiagnosticCentresListScreen extends StatefulWidget {
  const DiagnosticCentresListScreen({Key? key, required this.diagnosticCentres})
      : super(key: key);
  final String diagnosticCentres;
  @override
  State<DiagnosticCentresListScreen> createState() =>
      _DiagnosticCentresListScreenState();
}

class _DiagnosticCentresListScreenState
    extends State<DiagnosticCentresListScreen> {
