...
class NursingHomeListScreen extends StatefulWidget {
  const NursingHomeListScreen({Key? key, required this.nursingHome})
      : super(key: key);
  final String nursingHome;
  @override
  State<NursingHomeListScreen> createState() => _NursingHomeListScreenState();
}

class _NursingHomeListScreenState extends State<NursingHomeListScreen> {
