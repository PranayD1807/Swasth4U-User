import 'package:demo/screens/associate/nursing_home_list_screen.dart';
import 'package:demo/widgets/home_options.dart';
import 'package:demo/widgets/page_heading.dart';
import 'package:flutter/material.dart';

class NursingHomesScreen extends StatefulWidget {
  const NursingHomesScreen({Key? key}) : super(key: key);

  @override
  State<NursingHomesScreen> createState() => _NursingHomesScreenState();
}

class _NursingHomesScreenState extends State<NursingHomesScreen> {
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => NursingHomeListScreen(
                            nursingHome: tools[i]["text"],
                          ),
                        ),
                      );
                    },
