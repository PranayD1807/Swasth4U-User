...
class HealthcareInstrumentsListScreen extends StatefulWidget {
  const HealthcareInstrumentsListScreen(
      {Key? key, required this.healthCareInstrument})
      : super(key: key);
  final String healthCareInstrument;
  @override
  State<HealthcareInstrumentsListScreen> createState() =>
      _HealthcareInstrumentsListScreenState();
}

class _HealthcareInstrumentsListScreenState
    extends State<HealthcareInstrumentsListScreen> {
      ...
      body: Builder(builder: (context) {
        return SingleChildScrollView(
          ...
          child: Column(
            children: <Widget>[
              PageHeading(
                text: widget.healthCareInstrument,
              ),
              Container(
                margin:
