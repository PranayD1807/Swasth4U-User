import 'package:demo/screens/associate/healthcare_instruments_list_screen.dart';
import 'package:demo/widgets/home_options.dart';
import 'package:demo/widgets/page_heading.dart';
import 'package:flutter/material.dart';

class HealthcareInstrumentsScreen extends StatefulWidget {
  const HealthcareInstrumentsScreen({Key? key}) : super(key: key);

  @override
  State<HealthcareInstrumentsScreen> createState() =>
      _HealthcareInstrumentsScreenState();
}

class _HealthcareInstrumentsScreenState
    extends State<HealthcareInstrumentsScreen> {
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => HealthcareInstrumentsListScreen(
                            healthCareInstrument: tools[i]["text"],
                          ),
                        ),
                      );
                    },
